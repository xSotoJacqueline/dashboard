      ...
      {showPercentage && !isError ? (
        ...
        >
          ...
          >
            ...
            className={cn(
             'bg-red-500',
              'min-w-[66.45px] flex justify-center min-h-[20.3px] items-center px-[0.3em] p-0 font-medium text-sm text-white transition-colors duration-300'
            )}
            layout
            style={{ borderRadius: 999 }}
          >
           <span className="max-h-[10px] flex items-center justify-center">Error</span> 
          </motion.span>)}
