    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="bg-sidebar  max-h-[98cqh] my-20 m-2 rounded-lg text-sidebar-foreground w-(--sidebar-width) p-0 [&>button]:hidden"
          style={
            {
...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        "bg-[#F7F7F7] dark:bg-[#1f1e1e] relative flex w-full flex-1 flex-col",
