...
export function GeneralErrorContent({className, refetch, title=true }: {className?: string, title?:boolean, refetch?: (options?: RefetchOptions) => Promise<QueryObserverResult<any, Error>>}) {
    return (
