...
export function EarningsClientBonosChart() {
    ...
    return (
        <FullSizeCard hasFilter={false} identifier="chart3" cardContentClassName="min-h-[120px]" title="Ganancias generadas por cliente con bonos" description="Número total de clientes que han ganado utilizando bonos" Icon={DollarSignIcon}>
