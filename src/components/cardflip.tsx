...
// Componente para la tarjeta frontal
export function CardFront({ children, className }: CardFrontProps) {
  return (
    <div
      className={cn(
...
// Componente para la tarjeta trasera
...
export default function CardFlip({
  ...
  // Si se proporcionan children, usar esos en lugar de las tarjetas por defecto
  if (children) {
    return (
      <div
        className={cn(
  ...
  // Si se proporcionan frontCard y backCard personalizados
  ...
  // Tarjetas por defecto (comportamiento original)
  return (
    <div
      className={cn(
        'group relative h-[360px] w-full max-w-[300px] [perspective:2000px]',
