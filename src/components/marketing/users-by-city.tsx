...
export default function UsersByCity() {
  ...
  return (
        <div className="w-full h-full gap-6">
          <FullSizeCard hasFilter={false} identifier="chart3" className="w-full" cardContentClassName="min-h-[120px]" title="Usuarios activos por ciudad" description="Top 10 ciudades con más usuarios activos">
