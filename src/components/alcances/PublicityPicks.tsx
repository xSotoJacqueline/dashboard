...
export function PublicityPicks({title, description, Icon, identifier, values}: PublicityPicksProps) {
  ...
  return (
    <GeneralCard hasFilter={false} classNameContainer="overflow-hidden" className=" min-h-fit" cardContentClassName="h-fit" identifier={identifier} title={title} description={description} Icon={Icon}>
